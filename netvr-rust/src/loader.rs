...
pub extern "C" fn netvr_hook_get_instance_proc_addr(
    ...
    *w = Some(value);
    return Some(override_get_instance_proc_addr);
}

#[no_mangle]
pub extern "C" fn netvr_manual_destroy_instance(instance_handle: openxr_sys::Instance) {
    let status = override_destroy_instance(instance_handle);
...
extern "system" fn override_get_instance_proc_addr(
    ...
    xr_wrap(|| {
        ...
        if instance_handle == openxr_sys::Instance::NULL {
            check!(pfn::CreateInstance, override_create_instance);
        ...
        if name == "xrDestroyInstance" {
            ...
            if fns.automatic_destroy {
                check!(pfn::DestroyInstance, override_destroy_instance);
            } else {
